...
import { LayoutDashboard, Shield, Waypoints, FlaskConical, Settings, ChevronLeft, X } from "lucide-react";

export type TabKey = "overview" | "security" | "proxy" | "routing-lab" | "settings";
